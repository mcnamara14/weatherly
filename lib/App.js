...
import { current_observation, forecast, hourly_forecast } from './mock-data';
...
export default class App extends Component {
    constructor() {
      ...
      this.state = {
        city: '',
        stateUS: '',
        //would like to able to pass a single
    ...
    updateWeather(city, state) {
        //nest this code inside final then method using 'data' as the parameter.
        this.setState({
