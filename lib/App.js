...
export default class App extends Component {
    constructor() {
      ...
      this.state = {
        ...
        //package this up in a single data set if possible
    ...
    updateLocation(location){
        ...
        this.updateWeather(this.state.city, this.state.stateUS);
    }

    updateWeather(city, state) {
        fetch(`http://api.wunderground.com/api/0f1aa13fe5ed9a5d/forecast/geolookup/conditions/q/CO/Denver.json`)
            .then(data => data.json())
            .then(data => this.setState({currentTemperature: data.current_observation.temp_f}));
    }
