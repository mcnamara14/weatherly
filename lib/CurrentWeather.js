      ...
      <section className="currentWeather">
        <div className="focalConditions">
          ...
          <div className="focalInfo">
            ...
            <div className="currentHiLow">{props.forecast.highTemp}
              <sup>o</sup> / {props.forecast.lowTemp}<sup>o</sup></div>
          </div>
        </div>
        <div className="conditionDetails">
          <div className="detailHeadings">
            <h6>{props.forecast.day} <br />{props.forecast.month} 
              {props.forecast.dayInteger}, {props.forecast.year}</h6>
            <h2>{props.current.city} <br /><span>
              {props.current.state}</span></h2>
          </div>
          <hr />
